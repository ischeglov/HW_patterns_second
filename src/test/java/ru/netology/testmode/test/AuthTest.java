...
class AuthTest {
    ...
    void shouldSuccessfulLoginIfRegisteredActiveUser() {
        ...
        // TODO: добавляем логику теста, в рамках которого будет выполнена попытка входа в личный кабинет с учётными
    ...
    void shouldGetErrorIfNotRegisteredUser() {
        ...
        // TODO: добавляем логику теста в рамках которого будет выполнена попытка входа в личный кабинет
    ...
    void shouldGetErrorIfWrongLogin() {
        ...
        // TODO: добавляем логику теста в рамках которого будет выполнена попытка входа в личный кабинет с неверным
